...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.48\textwidth]{./figures/results/varying_rotation}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.48\textwidth]{./figures/results/varying_outflow}
	\end{center}
	\caption{\textbf{Caption:} Caption.
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.48\textwidth]{./figures/results/doppler_shift}
	\end{center}
	\caption{\textbf{Caption:} Caption.
