...
depth of $\tauh=10^7$.
Using this toy model we also show that the peaks of integrated spectra
...
such influence into already existing radiative transfer simulation
simulations and provide stronger footing to the interpretation of
present and future \lya kinematics maps
