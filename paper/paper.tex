...
\begin{figure*}
\begin{center}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout5_logtau5.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout25_logtau5.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout50_logtau5.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout5_logtau6.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout25_logtau6.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout50_logtau6.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout5_logtau7.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout25_logtau7.pdf}
\includegraphics[height=0.3\textwidth]{./figures/results/line_characterization_std_vout50_logtau7.pdf}
\end{center}
