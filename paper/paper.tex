...
valley for each $\theta$ and \tauh. Figure \ref{fig:valley_intensity} 
...
Regarding de Doppler shift... By this logic then, the quality and accuracy of 
the spectrum, obtained by a Doppler shift, increases with the optical depth \tauh. 
This because the more \tauh, the more anisotropic is the photons' distribution 
