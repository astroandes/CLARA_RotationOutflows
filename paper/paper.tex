...
Recent advances in instrumentation have revolutionized the kind of
kinematic studies that can be performed on galaxies with small angular
sizes on the sky.
For instances, spatially resolved spectra on compact dwarf galaxies
are now possible, and they confirm signs of gas kinematics showing
pure rotation kinematics \citep{2015A&A...577A..21C,2017A&A...600A.125C}
Recent mapping of high redshift circumgalactic regions are also able
to resolve kinematic evicend of large scale rotation
\citep{2018MNRAS.473.3907A} 
These systems with star formation, some neutral gas and low dust
contents are the kind of systems that are naturally expected to have
\lya emission.
What is the expected imprint of rotation on a resonant line such as
the \lya line?

The computational \lya modeling of rotating systems has only
