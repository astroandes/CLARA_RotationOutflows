...
\begin{figure*}
  ...
  \end{center}
  \caption{\textbf{Caption:} Caption. Tau 10E6.
    \label{fig:doppler_shift}}
\end{figure*}

In order to compare the line creative with the radiative transfer process that 
...
RT and DS approaches. We plot the results for each value in Figures 
...
\begin{figure*}
	\begin{center}
		\includegraphics[width=0.90\textwidth]{./figures/results/mean_line_6}
	\end{center}
	\caption{\textbf{Caption:} The dots represent the Radiative Transfer and
		the lines represent the Doppler Shift. Tau 10E6.
		\label{fig:mean_line}}
\end{figure*}

\begin{figure*}
	\begin{center}
		\includegraphics[width=0.90\textwidth]{./figures/results/standard_deviation_6}
	\end{center}
	\caption{\textbf{Caption:} The dots represent the Radiative Transfer and 
		the lines represent the Doppler Shift. Tau 10E6.
...
\begin{figure*}
	\begin{center}
		\includegraphics[width=0.90\textwidth]{./figures/results/skewness_6}
	\end{center}
	\caption{\textbf{Caption:} The dots represent the Radiative Transfer and 
		the lines represent the Doppler Shift. Tau 10E6.
		\label{fig:skewness}}
