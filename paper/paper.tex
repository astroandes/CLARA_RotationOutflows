...
\begin{figure}
	\begin{center}
		\includegraphics[height=0.1\textheight]{./figures/results/line_characterization_vi_vout5_vrot100_logtau5}
		\includegraphics[height=0.1\textheight]{./figures/results/line_characterization_vi_vout5_vrot100_logtau6}
		\includegraphics[height=0.1\textheight]{./figures/results/line_characterization_vi_vout5_vrot100_logtau7}
	\end{center}
