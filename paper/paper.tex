...
\begin{figure}
	\begin{center}
		\includegraphics[height=0.1\textheight]{./figures/results/line_characterization_mn_vout5_logtau7}
		\includegraphics[height=0.1\textheight]{./figures/results/line_characterization_mn_vout25_logtau7}
		\includegraphics[height=0.1\textheight]{./figures/results/line_characterization_mn_vout50_logtau7}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[height=0.11\textheight]{./figures/results/line_characterization_std_vout5_logtau7}
		\includegraphics[height=0.11\textheight]{./figures/results/line_characterization_std_vout25_logtau7}
		\includegraphics[height=0.11\textheight]{./figures/results/line_characterization_std_vout50_logtau7}
	\end{center}
...
in solid black, that combines these past two. This shows that there is in effect a 
Doppler Shift and justifies our choice to apply it after the outflows spectrum is 
obtained. 
