...
viewing angle.
We present a semi-analytic model that modifies the spectra of
...
patterns: coherent rotation plus and a random motions around the mean
value provided by rotation.  
...
already explored.
Here e present for the first time a study of the joint effects of
...
applied in our case.
We show that solid body rotation effects can be included
in the results of other radiative transfer model in the case of large
optical depths. In this case it is a good approximation to Doppler
...
(for largest range see Figure \ref{fig:varying_rotation}).
...
\begin{figure*}
	...
	\end{center}
	\caption{\textbf{Spectra for fixed outflow velocity:} We fixed $\vout=50$\kms. 
...
(for largest range see Figure \ref{fig:varying_outflow}).
...
and we get the same influence in it that previous works. 
...
Doppler Shift in velocity, weighted by  amount of photons that if
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_mn_vout5_logtau7}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_mn_vout25_logtau7}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_mn_vout50_logtau7}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_std_vout5_logtau7}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_std_vout25_logtau7}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_std_vout50_logtau7}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_skw_vout5_logtau7}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_skw_vout25_logtau7}
		\includegraphics[width=0.15\textwidth]{./figures/results/line_characterization_skw_vout50_logtau7}
	\end{center}
	\caption{\textbf{Skewness for RT and DS:} The dots represent the Radiative 
		Transfer and the lines represent the Doppler Shift. We fixed $\tauh=10^7$.
		\label{fig:skewness}}
\end{figure}
...
velocity of $\vout=75$\kms and rotation velocity of $\vrot=50$\kms. 
...
\begin{figure*}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{./figures/results/valley_intensity}
	\end{center}
	\caption{\textbf{Caption:} We fixed $\vout=75$\kms and $\vrot=50$\kms.
...
\color{black}
In Fig. \ref{fig:doppler} we present the spectrum pf a LAE taken from to different sides of the galaxy. As the LAE is rotating, one side is being redshifted while the other is blueshifted. We see that the combined spectrum is a weighted line, in black, that combines these past two. This shows that there is in effect a Doppler Shift and justifies our choice to apply it after the outflows spectrum is obtained. 

\begin{figure*}
	\begin{center}
		\includegraphics[width=0.55\textwidth]{./figures/discussion/doppler}
	\end{center}
	\caption{\textbf{Caption:} $\vout=25$\kms, $\vrot=100$\kms, $\tauh=10^5$.
		\label{fig:doppler}}
\end{figure*}
...
typical LAEs' numbers found in the literature. 
...
\begin{itemize}
	...
	\item The effect of optical depth \tauh in a LAE spectrum is to induces a 
	...
	\item Rotations induces a Doppler Shift in frequency of the only-outflow 
	spectrum of the LAE.
...
with more combinations of \vrot and \vout.
