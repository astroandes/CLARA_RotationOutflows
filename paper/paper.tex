...
coordinate; this model is fully characterized by $v_{\rm out}$, the
...
For each model setup we follow $10^5$ individual photons generated from
...
The values for the outflow velocity are lower than other values used in the
