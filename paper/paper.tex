...
These studies are now being extended to distant galaxies.

Some of those galaxies are expected to have high neutral gas contents
and thus show \lya\ emission with rotation imprints
\citep{2005A&A...433L...1B,2008ApJ...672..888T,2013MNRAS.434.2491G}
The computational modeling of systems showing rotation has only been
studied until recently by \cite{Garavito14}.
...
Dwarf Galaxy \citep{tololo}, that presented atypical features that
could be explained by pure rotation. 
...
\subsubsection{Match to \lya observations by MUSE}
...
comparison against observational data from MUSE.
