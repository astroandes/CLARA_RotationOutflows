...
taller and if it is $<0$ the right peak is taller. The BI is adimensional and
quantifies if the line has 1 or 2 peaks: it is  always $\geq 1$ \citep{Pearson1929} and the closer it is to 1, the more bimodal is the line (i.e. has 2 peaks).
...
\begin{figure*}
\begin{center}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout5_logtau5.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout25_logtau5.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout50_logtau5.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout5_logtau6.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout25_logtau6.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout50_logtau6.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout5_logtau7.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout25_logtau7.pdf}
\includegraphics[height=0.28\textwidth]{./figures/results/line_characterization_std_vout50_logtau7.pdf}
\end{center}
...
\begin{figure*}
\begin{center}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_skw_vout5_logtau5}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_skw_vout25_logtau5}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_skw_vout50_logtau5}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_skw_vout5_logtau6}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_skw_vout25_logtau6}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_skw_vout50_logtau6}
...
\begin{figure*}
\begin{center}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout5_logtau5}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout25_logtau5}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout50_logtau5}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout5_logtau6}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout25_logtau6}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout50_logtau6}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout5_logtau7}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout25_logtau7}
\includegraphics[height=0.31\textwidth]{./figures/results/line_characterization_bi_vout50_logtau7}
\end{center}
...
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout25_vrot100_logtau5}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout50_vrot100_logtau5}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout5_vrot100_logtau6}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout25_vrot100_logtau6}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout50_vrot100_logtau6}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout5_vrot100_logtau7}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout25_vrot100_logtau7}
\includegraphics[height=0.29\textwidth]{./figures/results/line_characterization_vi_vout50_vrot100_logtau7}
\end{center}
...
\begin{figure*}
	\begin{center}
		\includegraphics[height=0.3\textheight]{./figures/appendix/muse_vs_simulations.pdf}
		\includegraphics[height=0.3\textheight]{./figures/appendix/museall_vs_muserange.pdf}
		\includegraphics[height=0.3\textheight]{./figures/appendix/muserange_vs_simulations.pdf}
	\end{center}
