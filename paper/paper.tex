...
value in Figures \ref{fig:standard_deviation}, \ref{fig:skewness} and \ref{fig:bimodality},
respectively for $\tauh = 10^7$. We highlight that these 3 plots increase their fit 
tendency with a higher optical depth. The reasons why will be discussed in section 
\ref{sec:discussion}.
