...
\citep{2015A&A...577A..21C,2017A&A...600A.125C}; recent mapping of
...
kinematics traced by H$\alpha$ to \lya spectra \citep[e.g.][]{Herenz2016}. 

Theoretically speaking, what is then the expected imprint of rotation
on a resonant emission line such as the \lya line? To what extent is
possible to constrain rotational kinematics from the \lya emission line? 
