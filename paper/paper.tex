...
gas with additional solid body rotation. We reproduce the main features 
of the outcoming \lya line spectra with a simple semi-analytic model 
that modifies the spectra of outflows without rotation by adding a 
Doppler shift with the rotational information.
...
The conditions that allow for the emergence of the lYa line is that
these galaxies are star forming with a low dust content. 
...
These kinematic maps show that lyman alpha emitting galaxies have two 
overimposed velocity patterns: coherent rotation plus and a random
motions around the mean value provided by rotation. 
...
Figure \ref{fig:varying_rotation_small} summarizes the information.
...
\begin{figure*}
	\begin{center}
		\includegraphics[width=0.65\textwidth]{./figures/results/skewness_7}
	\end{center}
