...
Each panel shows the STD as a function of \vrot. The black triangles
...
The difference between the RT and DS increses with the outflow
...
upper bound of $\sim 7\%$, $3\%$ and $\sim 2\%$ for $\tauh=10^5$,
$10^6$ and $10^7$, respectively. 

Figure \ref{fig:skewness} presente the skwewness results for all the
models together with the DS comparison.
